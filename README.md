...
- Officer review, correction, recheck and finalization flow.
...
The current structured declaration/rule coverage is intentionally limited to MRP and net quantity for the supported retail-package profile. The mobile app supports Officer acceptance/correction, evidence recheck and resubmission, and finalization. Broader fields such as manufacturer/importer details, date declarations, consumer-care information, physical font-size measurement and automated misleading-label detection are outside the current prototype scope.
