...
The Flutter UI, camera integration, login/token-persistence screens, background scheduling, and finalization/report synchronization are **not** represented as implemented yet.
